module object_owner::object_owner {
    use std::string; use sui::dynamic_object_field;
    use sui::object::{Self, UID}; use sui::transfer;
    ...
    public entry fun transfer_child_2(receiver: &mut Parent, ctx: &mut TxContext) {
        let child = Child { id: object::new(ctx),name: string::utf8(b"transferring child") };
        dynamic_object_field::add(&mut receiver.id, 999, child);
    }
